    ...
    <footer className="footer">
      <div className="container">
        <div className="footer-top">
          ...
          <nav className="footer-nav">
            <ul className="footer-nav-list">
              ...
              <li className="footer-nav-item">
                <a href="#portfolio" className="footer-nav-link">
                  Portfolio
                </a>
              </li>
              <li className="footer-nav-item">
              ...
              <li className="footer-nav-item">
                <a href="#stack" className="footer-nav-link">
                  Stack
                </a>
              </li>
            </ul>
          ...
          <div className="social-links">
            ...
            <a href="http://www.linkedin.com/in/kelvin-dunkwu-726812327Vanity URL name" className="social-link" aria-label="LinkedIn">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
        ...
        <div className="footer-bottom">
          <p className="copyright">Reach out @+234 9132765728</p>
          <p className="copyright">kelvinilo62@gmail.com</p>
